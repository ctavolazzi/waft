...
try:
    ...
    from waft.api.routes.being import SpawnBeingRequest, MakeDecisionRequest
...
if result.returncode == 0 and '2e2c846' in result.stdout:
    print(f"✅ Commit is on remote branch")
else:
    print(f"❌ Commit not on remote")
