...
campaign_script_path = project_root / "_work_efforts" / "WE-260115-8vvn_self_playing_dnd_campaign_tavern_to_final_boss" / "SELF_PLAYING_CAMPAIGN_ELECTRON.py"
...
def register_dnd_campaign_routes(app: FastAPI):
    ...
    async def stop_campaign():
        ...
        if campaign_state["status"] != "running":
            raise HTTPException(
                status_code=400,
                detail="No campaign is currently running"
            )
