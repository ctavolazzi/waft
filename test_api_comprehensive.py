    ...
    try:
        ...
        try:
            proj_response = client.post(
                "/api/projects",
                json={"title": "Linking Test Project"},
                headers=headers
            )
            ...
            try:
                response = client.post(
                    f"/api/projects/{link_project_id}/work-efforts/{link_we_id}",
                    headers=headers
                )
            ...
            try:
                response = client.post(
                    f"/api/projects/{link_project_id}/work-efforts/INVALID-ID",
                    headers=headers
                )
                if response.status_code == 422:
        ...
        if project_id:
            try:
                ...
                if (updated["title"] == original["title"] and
