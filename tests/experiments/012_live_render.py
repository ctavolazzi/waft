...
async def run_experiment():
    ...
    biome = Biome(biome_id="biome_012", project_path=project_root, abiotic_factors=abiotic)
    ...
    print()
    print("RESULTS:")
    print("  ✓ 6 organisms birthed and visualized")
    print("  ✓ 10 items distributed across lattice")
    print("  ✓ 10 pulses executed with real-time rendering")
