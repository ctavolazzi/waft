...
def test_campaign_state():
    ...
    try:
        ...
        campaign.player_characters = {"Player1": "being_001", "Player2": "being_002"}
        ...
        console.print("  ✅ Session status updated to: IN_PROGRESS\n")
        ...
        console.print("  ✅ Summary generated:")
        ...
        console.print("[dim]Cleaned up temp directory[/dim]\n")
