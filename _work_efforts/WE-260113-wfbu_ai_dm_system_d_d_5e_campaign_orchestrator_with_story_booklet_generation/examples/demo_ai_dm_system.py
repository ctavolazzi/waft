...
def demo_ai_dm_system():
    ...
    try:
        ...
        console.print(f"  🎯 Choice made: [cyan]{event2.choice_made}[/cyan] - {event2.description[:50]}...")
        ...
        console.print(f"  ✅ DM decision made (simulated)")
        console.print(f"  📊 Recommendation: [cyan]Social encounter[/cyan]\n")
        ...
        booklet_path = orchestrator.generate_story_booklet(
            campaign_id=campaign.campaign_id,
            output_path=temp_dir / "campaign_booklet.pdf"
        )
