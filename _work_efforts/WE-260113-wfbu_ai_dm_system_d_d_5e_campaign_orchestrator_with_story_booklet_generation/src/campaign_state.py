...
class CampaignEvent:
    ...
    sequence_id: Optional[str] = None  # If from scenario engine
    choice_made: Optional[str] = None  # If player choice
    decision_matrix_id: Optional[str] = None  # If used decision matrix
...
class CampaignState:
    ...
    start_sequence_id: Optional[str] = None
    current_sequence_id: Optional[str] = None
...
class CampaignStateManager:
    ...
    def load_campaign(self, campaign_id: str) -> Optional[CampaignState]:
        """Load campaign by ID."""
    ...
    def add_event(
        ...
        decision_matrix_id: Optional[str] = None
    ) -> CampaignEvent:
        ...
        if not session:
            raise ValueError(f"Session {session_id} not found in campaign {campaign_id}. Available sessions: {[s.session_id for s in campaign.sessions]}")
