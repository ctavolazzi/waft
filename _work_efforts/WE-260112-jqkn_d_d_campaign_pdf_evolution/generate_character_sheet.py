...
def generate_blank_sheet(output_path: Optional[Path] = None):
...
def generate_filled_sheet(character_data: Dict[str, Any], output_path: Optional[Path] = None):
...
def main():
    ...
    example_character = {
        ...
        "ideals": [
            "Responsibility: I protect those who cannot protect themselves. (Good)"
        ],
        "bonds": [
            "I must protect my home village from the dangers that threaten it."
        ],
        "flaws": [
            "I'm too trusting of others and often get taken advantage of."
        ],
