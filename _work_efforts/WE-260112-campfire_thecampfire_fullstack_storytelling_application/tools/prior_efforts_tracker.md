...
tracker = PriorEffortsTracker(Path("_work_efforts/WE-260112-campfire_..."))
...
python tools/prior_efforts_tracker.py _work_efforts/WE-260112-campfire_... list

# Show statistics
python tools/prior_efforts_tracker.py _work_efforts/WE-260112-campfire_... stats

# Show lessons learned
python tools/prior_efforts_tracker.py _work_efforts/WE-260112-campfire_... lessons

# Show common errors
python tools/prior_efforts_tracker.py _work_efforts/WE-260112-campfire_... errors

# Export markdown report
python tools/prior_efforts_tracker.py _work_efforts/WE-260112-campfire_... export
```
