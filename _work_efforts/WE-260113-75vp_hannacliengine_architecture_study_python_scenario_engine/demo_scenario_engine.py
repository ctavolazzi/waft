...
class ScenarioEngine:
    ...
    def make_choice(self, sequence_id: str, choice_letter: str) -> Optional[str]:
        ...
        if container_add.get("container", "") != "":
            ...
            if container_name in self.containers:
                ...
                # Update event
                if self.events:
                    self.events[-1].containers_updated[container_name] = list(self.containers[container_name])
    ...
    def _extract_state_features(self, sequence_id: str) -> ScenarioState:
        ...
        sequence = self.scenario_data["sequences"][seq_index] if seq_index < len(self.scenario_data["sequences"]) else {}
    ...
    def recommend_choice(self, sequence_id: str) -> Optional[tuple]:
        """
