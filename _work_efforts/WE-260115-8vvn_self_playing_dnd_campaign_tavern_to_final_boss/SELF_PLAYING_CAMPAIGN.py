...
After {rounds} rounds of combat, {encounter_name} falls, defeated by the heroes' resolve.
    ...
    def generate_story_chapter(self, chapter_num: int, title: str, encounters: List[str]) -> Dict[str, Any]:
...
Light floods the chamber. The corruption is gone. You have won.
    ...
    def run_complete_campaign(self):
        ...
        console.print("\n" + "="*80)
        console.print("[bold cyan]🎲 SELF-PLAYING DND CAMPAIGN: TAVERN TO FINAL BOSS 🎲[/bold cyan]")
        console.print("="*80 + "\n")
