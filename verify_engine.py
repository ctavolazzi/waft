...
def test_dominant_option():
    ...
    scores = [
        Score("SuperCar", "Speed", 10),
        Score("SuperCar", "Comfort", 10),
        Score("Junker", "Speed", 1),
        Score("Junker", "Comfort", 1),
    ]
...
def test_trade_off():
    ...
    scores = [
        Score("Ferrari", "Cost", 1),
        Score("Ferrari", "Fun", 10),
        Score("Toyota", "Cost", 10),
        Score("Toyota", "Fun", 5),
    ]
...
def test_poison_pill():
    ...
    crits = [Criterion("Skills", 0.35), Criterion("Experience", 0.35), Criterion("Integrity", 0.30)]
