...
class NarrativeDecision(BaseModel):
    ...
    def validate(self, story_state: "StoryState") -> tuple[bool, List[str]]:
        ...
        if self.character and self.character in story_state.characters:
            ...
            if char.attributes.get("status") == "dead" and self.decision_type == DecisionType.CHARACTER_ACTION:
...
class DecisionValidator:
    ...
    @staticmethod
    def validate_decision(decision: NarrativeDecision, story_state: "StoryState") -> tuple[bool, List[str]]:
        """Validate a decision."""
