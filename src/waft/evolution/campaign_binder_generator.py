...
class CampaignBinderGenerator:
    ...
    def generate_binder(self, output_path: Optional[Path] = None) -> Path:
        """
    ...
    def _generate_markdown(self) -> str:
        ...
        lines.append(f"\n1. [Sessions](#sessions)")
        lines.append(f"2. [Character Progression](#character-progression)")
        lines.append(f"3. [Campaign Evolution](#campaign-evolution)")
        lines.append(f"\n---\n")
        ...
        # Character Progression
        lines.append(f"## Character Progression\n")
        ...
        # Campaign Evolution
        lines.append(f"## Campaign Evolution\n")
