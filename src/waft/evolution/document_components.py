...
class LayoutAlgorithm:
    ...
    def generate_layouts(
        ...
        for comp_type in [ComponentType.TITLE, ComponentType.IMAGE, ComponentType.ABSTRACT, 
                         ComponentType.ATTRIBUTION, ComponentType.SECTION]:
    ...
    def test_layout(
        ...
        for comp in layout.components:
            if success:
                ...
                comp.avg_fitness = (comp.avg_fitness * (comp.success_count - 1) + fitness) / comp.success_count
            else:
                comp.failure_count += 1
        
        return learning_entry
    
    def get_best_layout(self) -> Optional[DocumentLayout]:
    ...
    def get_learning_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'best_fitness': max(l['fitness'] for l in self.learning_log) if self.learning_log else 0.0,
        }
