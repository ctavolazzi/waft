...
class RealitySystem:
    ...
    def create_reality(
        ...
        self.source.register_permutation(
            ...
            metadata={"reality_type": reality_type.value, "configuration": configuration},
        )
    ...
    def end_reality(self, reality_id: str, outcomes: dict[str, Any] | None = None) -> Reality:
        """
    ...
    def spawn_being_into_reality(
        self, reality_id: str, being_id: str, being_config: dict[str, Any] | None = None
    ) -> dict[str, Any]:
        """
