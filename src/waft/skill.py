...
class SkillSystem:
    ...
    def create_skill(
        self, skill_name: str, skill_type: SkillType, initial_level: float = 0.0
    ) -> Skill:
        """
        Create a new skill.
        ...
        """
        skill = Skill(skill_name=skill_name, skill_type=skill_type, level=initial_level)

        self._save_skill(skill)
        return skill

    def inherit_skill(self, parent_skill: Skill, mutation_factor: float = 0.05) -> Skill:
        """
    ...
    def _load_skill(self, skill_name: str, skill_type: SkillType) -> Skill | None:
