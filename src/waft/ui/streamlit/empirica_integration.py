...
def render_empirica_page(empirica_manager: EmpiricaManager | None, project_path: Path):
    ...
    with st.form("create_session_form"):
        ...
        session_type = st.selectbox(
            "Session Type", ["development", "research", "debugging", "other"]
        )
...
def render_epistemic_dashboard(empirica_manager: EmpiricaManager | None):
