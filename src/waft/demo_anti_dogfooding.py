...
strict_out = api.solve(ProblemInput(
    problem="Is this system perfect?",
    mode=GuideMode.STRICT,
    max_iterations=1
))
...
lenient_out = api.solve(ProblemInput(
    problem="Is this system perfect?",
    mode=GuideMode.LENIENT,
    max_iterations=1
))
...
self_analysis = api.solve(ProblemInput(
