...
def oracle(
    ...
    try:
        ...
        if assess:
            ...
            guidance = oracle.provide_guidance(question, show_thinking=True, thinking_callback=thinking_callback)
            ...
            if reflection and reflection.get("reflection_summary"):
                console.print(f"[dim]💭 Reflection: {reflection['reflection_summary'][:80]}...[/dim]")
