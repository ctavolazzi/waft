...
class ScientificReport(FPDF):
    ...
    def add_metadata_rail(self, metadata: Dict[str, str], y_start: float) -> float:
        ...
        self.rect(self.l_margin, y_start, self.w - self.l_margin - self.r_margin, box_height, style="F")
        
        # Border
        self.set_draw_color(200, 200, 200)
        self.set_line_width(0.5)
        self.rect(self.l_margin, y_start, self.w - self.l_margin - self.r_margin, box_height, style="D")
        ...
        for key, value in metadata.items():
            ...
            if "[REDACTED]" in value_text:
                ...
                self._render_redacted_text(value_x, y, value_text, self.w - value_x - self.r_margin - 5)
            else:
...
def generate_genesis_artifact(config_path: Optional[Path] = None, output_path: Optional[Path] = None) -> Path:
    """
