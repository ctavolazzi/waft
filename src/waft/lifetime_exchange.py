...
class LifetimeExchange:
    ...
    def __init__(self, project_path: Path | None = None, karma_market: Any | None = None):
        """
    ...
    def list_offerings(
        self, exchange_type: ExchangeType | None = None, being_id: str | None = None
    ) -> list[dict[str, Any]]:
        """
    ...
    def purchase_offering(self, offering_id: str, buyer_being_id: str) -> dict[str, Any]:
        """
        ...
        self.karma_market._deduct_karma(
            buyer_being_id, offering["karma_price"], reason=f"Purchased offering: {offering_id}"
        )

        # Award karma to seller
        seller_being_id = offering["being_id"]
        self.karma_market._award_karma(
            seller_being_id, offering["karma_price"], reason=f"Sold offering: {offering_id}"
        )
