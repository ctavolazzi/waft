...
def demonstrate_modes():
    ...
    for mode, description in modes:
        ...
        print(f"  {mode.value:12s}: quality={output.quality_report.final_quality:.3f}, "
...
def demonstrate_quality_metrics():
    ...
    for step in output.step_history[:3]:  # Show first 3 steps
        ...
        print(f"    Dimensions: F={step['dimensions']['factuality']:.2f}, "
