...
def _format_optional_field(key: str, value: Optional[str]) -> str:
...
def _create_skills_module(technical_skills: List[Dict[str, Any]], soft_skills: List[Dict[str, Any]]) -> str:
