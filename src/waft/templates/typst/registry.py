...
class TypstTemplateMetadata:
    ...
    source_repo: Optional[str] = None  # e.g., "lapreprint", "dnd5e", "wenyuan"
...
class TypstTemplateRegistry:
    ...
    def _extract_metadata(self, wrapper_file: Path) -> Optional[TypstTemplateMetadata]:
        """
...
_registry: Optional[TypstTemplateRegistry] = None
