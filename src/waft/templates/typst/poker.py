...
from .wrappers.deckz_poker import CardFormat, GameType, Player, generate_deckz_poker
...
class PokerGame:
    ...
    def __init__(
        self, title: str, game_type: GameType = "texas_holdem", card_format: CardFormat = "medium"
    ):
        """
        ...
        self.community_cards: list[str] | None = None
        self.content: str = ""
