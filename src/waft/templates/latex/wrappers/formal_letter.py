...
def generate_formal_letter(
    ...
    sender_city_state_zip: str | None = None,
    ...
    recipient_city_state_zip: str | None = None,
    # Letter content
    ...
    signature_organization: str | None = None,
    ...
    **kwargs,
    ...
    pdf_path = compiler.compile(latex_content, output_path, working_dir=output_path.parent, runs=2)
