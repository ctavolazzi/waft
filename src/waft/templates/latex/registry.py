...
class LaTeXTemplateMetadata:
    ...
    source_repo: str | None = None  # e.g., "xuehai", "andres"
...
class LaTeXTemplateRegistry:
    ...
    def _extract_metadata(self, wrapper_file: Path) -> LaTeXTemplateMetadata | None:
        """
    ...
    def get_template(self, name: str) -> LaTeXTemplateMetadata | None:
        """
...
_registry: LaTeXTemplateRegistry | None = None
