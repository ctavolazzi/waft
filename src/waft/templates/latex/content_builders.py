...
def markdown_to_latex(markdown: str) -> str:
    ...
    for line in lines:
        if re.match(r"^[-*]\s+", line):
            ...
            if in_list:
                result_lines.append(
                    "\\end{itemize}" if "itemize" in result_lines[-2] else "\\end{enumerate}"
                )
                in_list = False
...
def build_essay_content(title: str, content: str, author: str = "Author", **kwargs) -> str:
    """
...
def build_presentation_content(title: str, content: str, author: str = "Author", **kwargs) -> str:
    """
...
def build_cv_content(
    name: str, content: str, email: str | None = None, phone: str | None = None, **kwargs
) -> str:
    """
...
def build_thesis_content(title: str, content: str, author: str = "Author", **kwargs) -> str:
    """
...
def build_report_content(title: str, content: str, author: str = "Author", **kwargs) -> str:
    """
