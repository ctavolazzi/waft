...
class TheVillage:
    ...
    def create_gathering(
        ...
        gathering_file.write_text(
            json.dumps(gathering.to_dict(), indent=2),
            encoding="utf-8"
        )
    ...
    def add_insight(
        ...
        gathering_file.write_text(
            json.dumps(gathering_data, indent=2),
            encoding="utf-8"
        )
    ...
    def add_wisdom(self, wisdom: str, source: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        wisdom_file.write_text(
            json.dumps(wisdom_entry, indent=2),
            encoding="utf-8"
        )
