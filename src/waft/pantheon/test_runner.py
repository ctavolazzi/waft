...
class TestRunner:
        ...
        for line in lines:
            ...
            if "PASSED" in line or "FAILED" in line or "SKIPPED" in line:
                ...
                if len(parts) >= 2:
                    ...
                    status = "passed" if "PASSED" in status_str else (
                        "failed" if "FAILED" in status_str else "skipped"
                    )
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "success_rate": (
                self.metadata.get("tests_passed", 0) / 
                max(self.metadata.get("tests_run", 1), 1)
            ) * 100,
