...
class RAGAgentMixin:
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._rag_chatbot: Optional[RAGChatbot] = None
    ...
    async def decide_with_rag(self, state: AgentState, original_decide):
        ...
        query = f"What decisions have been made for {self.config.role} with goal {self.config.goal}?"
