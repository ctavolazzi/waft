...
class RAGChatbot:
    ...
    def __init__(self, config: RAGConfig | None = None, project_path: Path | None = None):
        """
    ...
    def query(self, question: str, pdfs: list[str] | None = None, mode: str = "rag") -> str:
        """
        ...
        # Query pipeline
        response = self._pipeline.query(mode=mode, message=question, chatbot=[])
