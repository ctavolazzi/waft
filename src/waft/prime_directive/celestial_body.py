...
class CelestialMind:
    ...
    def _load(self):
        ...
        if self.evolution_patterns_file.exists():
            with open(self.evolution_patterns_file, 'r') as f:
...
class CelestialSpirit:
    ...
    def _load(self):
        ...
        if self.karma_evolution_file.exists():
            with open(self.karma_evolution_file, 'r') as f:
...
class CelestialBody:
    ...
    def __init__(
        ...
        celestial_body_path: Optional[Path] = None
    ):
        """
    ...
    def _load_body_state(self):
        ...
        if self.body_state_file.exists():
            with open(self.body_state_file, 'r') as f:
    ...
    def query_history(self, query_type: Optional[str] = None, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        """
