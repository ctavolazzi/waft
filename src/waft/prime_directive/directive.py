...
class PrimeDirective:
    ...
    def __init__(self, project_path: Path | None = None, directive_path: Path | None = None):
        """
    ...
    def _load(self):
        ...
        if "Observation Creates the Bridge" not in self.principles:
            self.add_principle(
                "Observation Creates the Bridge", reason="Realm colonization system requirement"
            )
    ...
    def add_principle(self, principle: str, reason: str | None = None) -> bool:
        """
        Add a new principle.
    ...
    def remove_principle(self, principle: str, reason: str | None = None) -> bool:
        """
        Remove a principle.
    ...
    def update_principle(
        self, old_principle: str, new_principle: str, reason: str | None = None
    ) -> bool:
        """
    ...
    def get_references(self, reference_type: str | None = None) -> list[dict[str, Any]]:
        """
