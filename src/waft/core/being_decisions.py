...
class BeingDecisionSystem:
    ...
    # Decision types
    DECISION_TYPES = ["learn_skill", "record_memory", "pursue_goal", "rest", "explore"]

    async def make_decision(
        self, being: "Being", available_options: list[str] | None = None
    ) -> dict[str, Any]:
        """
    ...
    def _filter_options(self, being: "Being", options: list[str]) -> list[str]:
        """
    ...
    def _calculate_weights(self, being: "Being", options: list[str]) -> list[float]:
        """
    ...
    def _execute_decision(self, being: "Being", decision_type: str) -> dict[str, Any]:
        """
        ...
        if decision_type == "learn_skill":
            ...
            if not experience.get("stamina_depleted"):
                ...
                experience["description"] = (
                    "Attempted to learn a skill (made mistakes due to exhaustion)"
                )
            ...
            if not experience.get("stamina_depleted"):
                ...
                base_intensity = 0.3
                experience["description"] = (
                    "Attempted to pursue goal (poor execution due to exhaustion)"
                )
            experience["intensity"] = base_intensity * action_intensity
            ...
            if not experience.get("stamina_depleted"):
                ...
                experience["description"] = (
                    "Explored reality (missed opportunities due to exhaustion)"
                )
            experience["intensity"] = base_intensity * action_intensity
