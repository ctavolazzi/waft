...
class OraclePersonality:
    ...
    def __init__(self, personality_data: Optional[Dict[str, Any]] = None):
        """
    ...
    def get_phrase(self, category: str, trait: Optional[str] = None) -> str:
        """
    ...
    def adapt_to_context(self, epistemic_phase: str, uncertainty: float, knowledge: float) -> Dict[str, Any]:
        """
    ...
    def apply_personality_to_text(self, text: str, context: Optional[Dict[str, Any]] = None) -> str:
        """
