...
class OracleJournal:
    ...
    def remember_insight(self, insight: str, impact: float = 0.5, context: Optional[Dict[str, Any]] = None) -> None:
        """
    ...
    def remember_successful_recommendation(
        ...
        if len(self.memory["successful_recommendations"]) > 100:
            self.memory["successful_recommendations"] = self.memory["successful_recommendations"][-100:]
        ...
        if len(self.patterns["phase_recommendations"][epistemic_phase]) > 20:
            self.patterns["phase_recommendations"][epistemic_phase] = \
                self.patterns["phase_recommendations"][epistemic_phase][-20:]
    ...
    def get_memory_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "successful_recommendations_count": len(self.memory.get("successful_recommendations", [])),
