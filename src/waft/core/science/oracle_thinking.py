...
def display_thinking_step_by_step(
    ...
    if step == "PREFLIGHT":
        if data.get("status"):
            ...
            console.print(f"   [cyan]✓ Assessment complete[/cyan]")
        ...
        if data.get("status"):
            ...
            if reflection:
                ...
                console.print(f"   [cyan]✓ Reflection complete[/cyan]")
                if data.get("thinking"):
                    console.print(f"   [dim]   💭 {data['thinking']}[/dim]")
                console.print(f"   [dim]   Found {len(relevant_experiences)} relevant experiences[/dim]")
                ...
                console.print(f"   [dim]   No past experiences found[/dim]")
                if data.get("thinking"):
                    console.print(f"   [dim]   💭 {data['thinking']}[/dim]")
        ...
        if data.get("status"):
            ...
            console.print(f"   [cyan]✓ Decision gate evaluated[/cyan]")
            console.print(f"   [dim]   Findings: {findings_count}, Unknowns: {unknowns_count}[/dim]")
        ...
        console.print(f"   [cyan]✓ Recommendation generated[/cyan]")
        if data.get("thinking"):
            console.print(f"   [dim]   💭 {data['thinking']}[/dim]")
        ...
        if data.get("status"):
            ...
            console.print(f"   [cyan]✓ Calculation complete[/cyan]")
            if data.get("thinking"):
                console.print(f"   [dim]   💭 {data['thinking']}[/dim]")
        ...
        if data.get("guidance_provided"):
            ...
            if knowledge_delta != 0 or uncertainty_delta != 0:
                console.print(f"   [dim]   Knowledge Δ: {knowledge_delta:+.0%}, Uncertainty Δ: {uncertainty_delta:+.0%}[/dim]")
