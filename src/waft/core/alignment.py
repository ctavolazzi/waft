...
class AlignmentSystem:
    ...
    def calculate_alignment_between_beings(
        self,
        arrow1: ArrowOfIntent,
        arrow2: ArrowOfIntent
    ) -> float:
        """
    ...
    def calculate_alignment_with_outcome(
        self,
        intended_arrow: ArrowOfIntent,
        actual_arrow: ArrowOfIntent
    ) -> float:
        """
    ...
    def calculate_harm_help_alignment(
        ...
        harm_or_help: Optional[Harm] = None,
        help_event: Optional[Help] = None
    ) -> float:
        """
