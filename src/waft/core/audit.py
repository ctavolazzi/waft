...
class AuditManager:
    ...
    def run_audit(self, output_path: str | None = None) -> dict[str, Any]:
        """
    ...
    def _generate_audit_report(self, audit_data: dict[str, Any], analysis: dict[str, Any]) -> str:
        ...
        content = []
        content.append("# Conversation Audit\n\n")
        ...
        content.append(
            "_This audit analyzes the conversation for quality, completeness, issues, and provides recommendations._\n\n"
        )
        content.append(
            "**Note**: This is a framework audit. The AI will analyze the actual conversation context and fill in specific findings.\n\n"
        )
        ...
        content.append(
            f"- **Uncommitted Files**: {audit_data['git'].get('uncommitted_count', 0)}\n\n"
        )
    ...
    def _display_summary(self, analysis: dict[str, Any], audit_file: Path):
        ...
        self.console.print("  • Quality: Framework ready for AI analysis")
        self.console.print("  • Issues: To be identified by AI")
        self.console.print("  • Recommendations: To be generated by AI")

        self.console.print(
            f"\n[bold green]✅ Audit saved:[/bold green] {audit_file.relative_to(self.project_path)}\n"
        )
        self.console.print(
            "[dim]Note: This is a framework. The AI will analyze the actual conversation[/dim]"
        )
