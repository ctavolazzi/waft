...
class GoalManager:
    ...
    def create_goal(
        self, name: str, objective: str, steps: list[str] | None = None
    ) -> dict[str, Any]:
        """
        Create a new goal.
    ...
    def show_goal(self, name: str) -> dict[str, Any] | None:
        """
        Show goal details.
    ...
    def _read_goal(self, goal_file: Path) -> dict[str, Any] | None:
    ...
    def _display_goal(self, goal: dict[str, Any]):
        ...
        if steps:
            ...
            for step in steps:
                ...
                table.add_row(str(step.get("number", "")), step.get("description", ""), status)
