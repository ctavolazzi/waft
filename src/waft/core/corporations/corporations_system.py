...
class CorporationsSystem:
    ...
    def create_corporation(
        ...
        if not validate_corp_id(corp_id):
            raise ValueError(
                f"Invalid corp_id: {corp_id}. Must contain only alphanumeric characters, underscores, and hyphens."
            )
    ...
    def get_corporation(self, corp_id: str) -> Corporation | None:
        """
