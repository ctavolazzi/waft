...
class Corporation:
    ...
    def __init__(
        ...
        if initial_capital:
            self.financial_state.record_revenue(
                initial_capital,
        ...
        # Corporate path
        self.corp_path = self.project_path / "_realms" / "bureaucracy_realm" / "corporations" / self.corp_id
    ...
    def add_department(self, name: str, department_id: Optional[str] = None) -> Department:
        """
    ...
    def get_employee(self, being_id: str) -> Optional[Employee]:
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any], project_path: Optional[Path] = None) -> "Corporation":
