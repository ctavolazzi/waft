...
class Transaction:
    ...
    def __init__(
        ...
        if not validate_financial_amount(
            Decimal(str(amount)), min_amount=Decimal("0"), allow_negative=False
        ):
        ...
        self.invoice_path: str | None = None
...
def create_customer_invoice_transaction(
    transaction_id: str, customer_name: str, amount: Decimal, description: str
) -> Transaction:
    """
