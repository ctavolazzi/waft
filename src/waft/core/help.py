...
class HelpManager:
    ...
    COMMAND_CATEGORIES = {
        "Core Workflow": [
            (
                "phase1",
                "Gather all project data, create interactive dashboard. Use when starting work, need full overview.",
            ),
            (
                "analyze",
                "Analyze Phase 1 data, generate insights and action plans. Use after Phase 1, need recommendations.",
            ),
            (
                "resume",
                "Load last session summary, compare current state, continue previous work. Use when starting new session.",
            ),
            (
                "continue",
                "Reflect on current work, then continue with awareness. Use mid-work, want reflection without stopping.",
            ),
            (
                "proceed",
                "Verify context and assumptions before continuing. Use when need to check understanding before acting.",
            ),
            (
                "reflect",
                "Prompt AI to write reflective journal entries. Use when want AI to document thoughts, learnings, experiences.",
            ),
            (
                "checkpoint",
                "Document current state, progress, todos. Use when need snapshot of current situation.",
            ),
            (
                "verify",
                "Verify project state with traceable evidence. Use when need to verify project is in good state.",
            ),
            (
                "checkout",
                "Run cleanup, documentation, summary tasks. Use when ending session, want comprehensive wrap-up.",
            ),
        ],
        "Analysis & Planning": [
            (
                "consider",
                "Analysis and recommendations for decisions. Use when need structured analysis of options.",
            ),
            (
                "decide",
                "Decision matrix with mathematical calculations. Use when need quantitative decision support.",
            ),
            (
                "explore",
                "Deep exploration of codebase or concepts. Use when need thorough understanding of topic.",
            ),
        ],
        "Project Management": [
            (
                "orient",
                "Project startup process and orientation. Use when starting new project or returning after break.",
            ),
            (
                "spin-up",
                "Quick orientation and context gathering. Use when need fast project overview.",
            ),
            (
                "engineer",
                "Complete workflow from analysis to implementation. Use when want full engineering process.",
            ),
        ],
        "Utility": [
            (
                "visualize",
                "Quick interactive browser dashboard. Use when want visual representation of project state.",
            ),
            (
                "stats",
                "Session statistics (files, lines, activity). Use when want to see what was accomplished in session.",
            ),
            (
                "analytics",
                "Session analytics and historical analysis. Use when want to understand work patterns over time.",
            ),
            (
                "recap",
                "Conversation recap and session summary. Use when want summary of conversation/session.",
            ),
        ],
        "Goal Management": [
            (
                "goal",
                "Track larger goals, break into steps. Use when have larger objective, want to track progress.",
            ),
            (
                "next",
                "Identify next step based on goals. Use when want to know what to do next, need direction.",
            ),
        ],
    }
    ...
    def _show_filtered(self, category: str | None = None, search: str | None = None):
    ...
    def _show_usage_examples(self):
        ...
        self.console.print(
            "[dim]Tip: Use /help --command <name> for detailed command information[/dim]\n"
        )
