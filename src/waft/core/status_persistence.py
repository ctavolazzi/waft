...
class StatusPersistence:
    ...
    def load_status_snapshot(
        self, snapshot_id: str, verify_integrity: bool = True
    ) -> dict[str, Any] | None:
        """
    ...
    def compare_snapshots(self, snapshot_id_1: str, snapshot_id_2: str) -> dict[str, Any] | None:
        """
    ...
    def get_status_history(
        self, metric_path: str, limit: int | None = None
    ) -> list[dict[str, Any]]:
        """
...
def save_status_snapshot(
    status: dict[str, Any], project_path: Path | None = None, snapshot_id: str | None = None
) -> dict[str, Any]:
    """
...
def load_status_snapshot(
    snapshot_id: str, project_path: Path | None = None, verify_integrity: bool = True
) -> dict[str, Any] | None:
    """
