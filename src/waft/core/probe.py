                ...
                if target_path.suffix in [".py", ".md", ".txt", ".json", ".yaml", ".yml"]:
                    try:
                        with open(target_path, "r", encoding="utf-8") as f:
                            ...
                            data["total_lines"] = sum(1 for _ in open(target_path, "r", encoding="utf-8"))
                    except:
                        pass
...
class ProbeCollector:
    ...
    def summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_duration_ms": sum(r.duration_ms for r in all_results) / len(all_results) if all_results else 0
        }
