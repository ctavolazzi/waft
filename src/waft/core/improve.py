...
class ImproveManager:
    ...
    def _gather_context(self, focus: str | None, recent_only: bool) -> dict[str, Any]:
    ...
    def _get_git_status(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"modified": len(modified), "added": len(added), "files": modified + added}
        except Exception:
    ...
    def _display_improvements(self, improvements: list[Improvement]) -> None:
        ...
        # Summary table
        summary_table = Table(
            title="Improvement Summary", show_header=True, header_style="bold cyan"
        )
        ...
        for priority in ["critical", "high", "medium", "low"]:
            ...
            if count > 0:
                ...
                summary_table.add_row(f"[{color}]{priority.upper()}[/{color}]", "All", str(count))
    ...
    def _save_report(
        self, improvements: list[Improvement], output_path: Path, context: dict[str, Any]
    ) -> None:
