...
class ArrowOfIntent:
    ...
    def normalize(self) -> "ArrowOfIntent":
        ...
        return ArrowOfIntent(self.x / mag, self.y / mag, self.z / mag)
...
class Harm:
    ...
    target_being_id: str | None  # Who was harmed (None = system/environment)
...
class Help:
    ...
    target_being_id: str | None  # Who was helped (None = system/environment)
    arrow_of_intent: ArrowOfIntent  # Source being's intent direction
