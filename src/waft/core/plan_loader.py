...
class PlanData:
    ...
    def get_section(self, title: str) -> PlanSection | None:
...
class PlanLoader:
    ...
    def find_most_recent_plan(self) -> Path | None:
        """
    ...
    def find_plan_by_name(self, name: str) -> Path | None:
        """
    ...
    def load_plan(self, plan_path: Path | None = None) -> PlanData:
        """
    ...
    def _parse_sections(self, content: str) -> list[PlanSection]:
        ...
        for i, line in enumerate(lines):
            ...
            if heading_match:
                ...
                current_section = PlanSection(title=title, level=level, content="", start_line=i)
                current_content = []
            else:
                if current_section is not None:
