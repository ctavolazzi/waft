...
from .problem_detector import Problem, ProblemDetector
from .self_modification import SelfModificationEngine
from .solution_engineer import ImplementationResult, Solution, SolutionEngineer
...
class SelfEngineeringLoop:
    ...
    def __init__(
        self, scenario_runner: Callable[[], dict[str, Any]], project_path: str | None = None
    ):
        """
        ...
        while iteration < max_iterations:
            ...
            for problem, diagnosis, solution in solutions:
                ...
                result = self.solution_engineer.implement_solution(
                    solution, modification_engine=self.modification_engine
                )
    ...
    def _run_scenario(self) -> dict[str, Any]:
        ...
        execution_result = {"context": {}, "fitness_gained": 0.0, "success": False}
    ...
    def get_recent_improvements(self, count: int = 5) -> list[Improvement]:
        ...
        return sorted(self.improvements, key=lambda i: i.timestamp, reverse=True)[:count]
