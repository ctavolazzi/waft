...
from .notebook import NotebookEntry, Reflection, ActionableType, NotebookEntryType


class ActionableCreator:
    """Creates actionable items from notebook findings."""
    
    def __init__(self, project_path: Path, work_efforts_dir: Path, scenarios_dir: Path, quests_dir: Path, empirica_manager=None):
        """
    ...
    def create_work_effort_from_entry(self, entry: NotebookEntry, use_empirica: bool = True) -> Dict[str, Any]:
        """
