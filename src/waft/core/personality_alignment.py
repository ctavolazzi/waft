...
class PersonalityAlignment:
    ...
    def calculate_alignment(
        ...
        if experience_type == "positive":
            ...
            pain = (1.0 - alignment_score) * experience_intensity * 0.1  # Minimal pain from positive experiences
        elif experience_type == "negative":
            pleasure = alignment_score * experience_intensity * 0.1  # Minimal pleasure from negative experiences
    ...
    def _calculate_personality_match(
        ...
        if personality_type == "analytical":
            ...
            if "learn" in experience_description.lower() or "skill" in experience_description.lower():
                match = min(1.0, match + 0.2)
        elif personality_type == "creative":
            # Creative beings prefer exploration/novel experiences
            if "explore" in experience_description.lower() or "discover" in experience_description.lower():
                match = min(1.0, match + 0.2)
