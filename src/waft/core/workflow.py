...
class ComposeManager:
    ...
    def _parse_natural_language(self, text: str) -> dict[str, Any] | None:
        """
    ...
    def _load_workflow(self, name: str) -> dict[str, Any] | None:
    ...
    def _execute_workflow(self, workflow: dict[str, Any]) -> dict[str, Any]:
        ...
        for i, step in enumerate(steps, 1):
            ...
            self.console.print(
                f"  [dim]Would execute: waft {cmd_name} with params {params}[/dim]\n"
            )

        self.console.print("[bold green]✅ Workflow execution plan created[/bold green]")
        self.console.print("[dim]Note: Actual command execution not yet implemented[/dim]\n")
    ...
    def show_workflow(self, name: str) -> dict[str, Any] | None:
