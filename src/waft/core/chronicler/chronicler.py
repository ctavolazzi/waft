...
class TheChronicler:
    ...
    def __init__(self, project_path: Path, oracle: TheOracle | None = None, reset_hour: int = 5):
        """
    ...
    def start(self):
        ...
        try:
            fs_observer = FileSystemObserver(self.project_path, self._observation_callback)
            fs_observer.start()
        ...
        git_observer = GitObserver(self.project_path, self._observation_callback)
        ...
        we_observer = WorkEffortObserver(self.project_path, self._observation_callback)
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "observers_active": len(
                [o for o in self._observers if hasattr(o, "is_alive") and o.is_alive()]
            ),
