...
class ObservationStorage:
    ...
    def __init__(self, project_path: Path):
        ...
        self._lock = Lock()
        self._current_day_dir: Optional[Path] = None
        self._current_day: Optional[str] = None
    
    def get_day_dir(self, date: Optional[datetime] = None) -> Path:
        """
    ...
    def store_observation(self, observation: Dict[str, Any], date: Optional[datetime] = None) -> Path:
        """
    ...
    def get_genesis_count(self, date: Optional[datetime] = None) -> int:
    ...
    def get_exodus_count(self, date: Optional[datetime] = None) -> int:
