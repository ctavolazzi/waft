...
class ScenarioOrchestrator:
    ...
    def _run_encounter_scenario(
        ...
        console.print(Panel.fit(
            "[bold cyan]⚔️  ENCOUNTER SCENARIO[/bold cyan]",
            style="cyan"
        ))
    ...
    def _run_exploration_scenario(
        ...
        console.print(Panel.fit(
            "[bold cyan]🗺️  EXPLORATION SCENARIO[/bold cyan]",
            style="cyan"
        ))
        ...
        locations = [
            "Ancient Ruins", "Mysterious Forest", "Hidden Cave",
            "Abandoned Village", "Mountain Pass", "River Crossing"
        ]
        import random
    ...
    def _run_lore_scenario(
        ...
        console.print(Panel.fit(
            "[bold cyan]📖 LORE BUILDING SCENARIO[/bold cyan]",
            style="cyan"
        ))
        ...
        import random
        npc_names = [
            "Elder Thorne", "Merchant Kael", "Scholar Elara",
            "Guard Captain Rik", "Mystic Zara", "Bard Finn"
        ]
        event_types = [
            "Festival Celebration", "Ancient Prophecy", "Trade Agreement",
            "Mysterious Sign", "Heroic Deed", "Legendary Tale"
        ]
    ...
    def _run_resume_scenario(self) -> Dict[str, Any]:
        ...
        console.print(Panel.fit(
            "[bold cyan]▶️  RESUMING SCENARIO[/bold cyan]",
            style="cyan"
        ))
    ...
    def get_party_state(self) -> Optional[Dict[str, Any]]:
