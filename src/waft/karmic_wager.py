...
from .karma import InsufficientKarmaError, KarmaMerchant
...
class KarmicWagerSystem:
    ...
    def __init__(
        self, project_path: Path | None = None, karma_merchant: KarmaMerchant | None = None
    ):
        """
    ...
    def place_wager(
        ...
        if current_karma < karma_amount:
            raise InsufficientKarmaError(f"Insufficient karma: {current_karma} < {karma_amount}")
    ...
    def resolve_wager(
        ...
        wager_id: str,
        outcome: Any,
        resolver: Callable[[KarmicWager, Any], bool] | None = None,
    ) -> dict[str, Any]:
        """
    ...
    def get_active_wagers(self, soul_id: str | None = None) -> list[KarmicWager]:
    ...
    def get_wager_history(
        self, soul_id: str | None = None, limit: int = 50
    ) -> list[dict[str, Any]]:
        """Get wager history."""
...
def wager_on_hypothesis(
    ...
    return wager_system.place_wager(
        ...
        karma_amount=karma_amount,
        prediction=prediction,
        resolution_criteria={"hypothesis": hypothesis, "study_session_id": study_session_id},
...
def wager_on_fitness(
    ...
    return wager_system.place_wager(
        ...
        resolution_criteria={"threshold": threshold, "direction": direction},
        odds=odds,
    )
