...
def bootstrap_epistemic_state(
    ...
    print(f"✓ Estimated vectors: know={vectors['foundation']['know']:.0%}, uncertainty={vectors['uncertainty']:.0%}")
    ...
    if context and context.get("epistemic_state"):
        ...
        print(f"✓ Epistemic state available!")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Bootstrap epistemic state from codebase analysis"
    )
    parser.add_argument(
        "--path", "-p",
        type=str,
