...
doc.build(story)"""
        ...
        story.append(Paragraph("<code>pip install reportlab</code>", code_style))
        story.append(Paragraph("No system dependencies required - pure Python!", styles["Normal"]))
...
"""
        ...
        format_vars = {
            ...
            if PDF_LIBRARIES["pypdf"]["installed"]
            else "❌ Not Installed",
            "pymupdf_class": "installed"
            if PDF_LIBRARIES["pymupdf"]["installed"]
            else "not-installed",
            "pymupdf_status": "✅ Installed"
            if PDF_LIBRARIES["pymupdf"]["installed"]
            else "❌ Not Installed",
            "matplotlib_class": "installed"
            if PDF_LIBRARIES["matplotlib"]["installed"]
            else "not-installed",
            "matplotlib_status": "✅ Installed"
            if PDF_LIBRARIES["matplotlib"]["installed"]
            else "❌ Not Installed",
            "pillow_class": "installed"
            if PDF_LIBRARIES["pillow"]["installed"]
            else "not-installed",
            "pillow_status": "✅ Installed"
            if PDF_LIBRARIES["pillow"]["installed"]
            else "❌ Not Installed",
            "jinja2_weasyprint_class": "installed"
            if PDF_LIBRARIES["jinja2_weasyprint"]["installed"]
            else "not-installed",
            "jinja2_weasyprint_status": "✅ Installed"
            if PDF_LIBRARIES["jinja2_weasyprint"]["installed"]
            else "❌ Not Installed",
        }
