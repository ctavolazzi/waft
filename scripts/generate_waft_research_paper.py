...
Examples:
  ...
  %(prog)s --question "How does evolution work?" \\
    ...
    parser.add_argument("--question", "-q", required=True, help="Primary research question")

    parser.add_argument("--hypothesis", "-h", required=True, help="Testable hypothesis")

    parser.add_argument(
        "--objectives", "-o", nargs="+", required=True, help="Study objectives (one or more)"
    )
