...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print(
            "  create_brief.py title:'Project Brief' doc-id:'BRIEF-001' cover-header:'TELEPORT MASSIVE'"
        )
        ...
        print(
            "  cover-warning:json       - Cover warning (JSON: {'message': '...', 'severity': 'CRITICAL'})"
        )
        print(
            "  cover-signature:json     - Cover signature (JSON: {'role': '...', 'name': '...', 'date': '...'})"
        )
