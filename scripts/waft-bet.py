...
Examples:
  ...
  %(prog)s list
    ...
    hyp_parser.add_argument(
        "--prediction",
        choices=["confirmed", "refuted"],
        default="confirmed",
        help="Predict confirmed or refuted (default: confirmed)",
    )
    hyp_parser.add_argument(
        "--odds", type=float, default=2.0, help="Payout multiplier (default: 2.0)"
    )
    ...
    fit_parser.add_argument("--threshold", type=float, required=True, help="Fitness threshold")
    ...
    fit_parser.add_argument(
        "--odds", type=float, default=1.5, help="Payout multiplier (default: 1.5)"
    )
    ...
    study_parser.add_argument(
        "--min-findings", type=int, default=1, help="Minimum findings for success (default: 1)"
    )
    study_parser.add_argument(
        "--min-conclusions",
        type=int,
