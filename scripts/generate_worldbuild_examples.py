...
def create_character_profile():
    ...
    doc.add_text("Elara specializes in evocation and divination magic. Her signature spells include:")
    doc.add_log_block([
    ...
    doc.add_warning_block(
        "Character is marked as dangerous. Handle with caution during roleplay.",
        severity="CAUTION"
    )
