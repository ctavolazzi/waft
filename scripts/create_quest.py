...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Create a whimsical Quest (Fae-guided)"
    )
    parser.add_argument(
        "description",
        nargs="?",
        help="Quest description (open-ended, creative work)"
    )
    parser.add_argument(
        "--name",
        type=str,
        help="Quest name (auto-generated from description if not provided)"
    )
    parser.add_argument(
        "--fae-guidance",
        type=str,
        help="Fae blessing/guidance (auto-generated if not provided)"
    )
    parser.add_argument(
        "--difficulty",
        type=int,
        help="Quest difficulty (1-10, auto-calculated if not provided)"
    )
    parser.add_argument(
        "--project-path",
        type=Path,
    ...
    parser.add_argument(
        "--from-plan",
        type=Path,
        help="Create quest from plan file"
    )
