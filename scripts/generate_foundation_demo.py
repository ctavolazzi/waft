...
try:
    ...
    engine.add(TextBlock("Professional tables with headers, borders, and automatic column sizing:"))
    ...
    engine.add(
        TextBlock("Monospace log entries for system output, terminal logs, or technical data:")
    )
