...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Trace PDF files - find locations and history"
    )
    parser.add_argument(
        "pdf_path",
        nargs="?",
        help="PDF path or filename to trace"
    )
    parser.add_argument(
        "--project-path",
        type=Path,
    ...
    parser.add_argument(
        "--list",
        action="store_true",
        help="List all PDFs in registry"
    )
    parser.add_argument(
        "--search",
        type=str,
        help="Search for PDFs matching pattern"
    )
    parser.add_argument(
        "--external-only",
        action="store_true",
        help="Show only PDFs on external drive"
    )
    parser.add_argument(
        "--stats",
        action="store_true",
