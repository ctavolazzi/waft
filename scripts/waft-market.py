...
from src.waft.karma_market import AfterlifeKarmaMarket, KarmaMarket
...
Examples:
  ...
  %(prog)s treasure buy tools advanced_codebase_search --soul-id waft_001
    ...
    # Treasure commands
    treasure_parser = subparsers.add_parser(
        "treasure", help="Afterlife Karma Market (Treasure Tavern)"
    )
    ...
    try:
        if args.command == "list":
            ...
            # End lifetime
            lifetime = market.end_lifetime(args.lifetime_id, karma_earned=args.karma_earned)
