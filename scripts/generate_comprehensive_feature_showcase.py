...
"""
    ...
    distilled = distiller.distill_text(
        chat_content,
        title="WAFT Evolution System Showcase"
    )
...
def main():
    ...
    try:
        ...
        for doc_path in template_docs:
            section1.add_document(DocumentEntry(
                path=doc_path,
        ...
        section2 = binder.add_section(
            "Section 2: Foundation V1",
            description="Block-based API with FPDF2",
            color="#2ecc71"
        )
        section2.add_document(DocumentEntry(
        ...
        section3.add_document(DocumentEntry(
        ...
        section4.add_document(DocumentEntry(
        ...
        section5.add_document(DocumentEntry(
            path=evolution_doc,
