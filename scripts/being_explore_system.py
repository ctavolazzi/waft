...
"""
    ...
    console.print(
        f"[green]✓[/green] Structure analysis complete ({len(structure_obs)} observations)\n"
    )
    ...
    console.print(
        f"[green]✓[/green] Architecture analysis complete ({len(arch_obs)} observations)\n"
    )
    ...
    console.print(
        f"[green]✓[/green] Pattern discovery complete ({len(pattern_obs)} observations)\n"
    )
    ...
    console.print(
        f"[green]✓[/green] Functionality mapping complete ({len(func_obs)} observations)\n"
    )
...
"""
        ...
        fallback_path = (
            project_root / "_pyrite" / "active" / f"EXPLORATION_REPORT_{being.being_id}.md"
        )
