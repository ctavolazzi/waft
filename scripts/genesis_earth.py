...
def create_earth_realm(desktop_path: Path) -> Path:
    ...
    console.print(Panel.fit(
        "[bold cyan]🌍 Creating Earth Realm[/bold cyan]",
        style="cyan"
    ))
    ...
    try:
        ...
        console.print(f"[bold red]❌ Error creating Earth Realm[/bold red]")
    ...
    console.print(f"[green]✓[/green] Earth Realm structure verified\n")
