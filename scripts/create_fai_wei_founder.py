...
from waft.core.corporations.corporations_system import CorporationsSystem
...
def update_founders_file(project_path: Path, fai_wei: Being):
    ...
    founders_path = (
        project_path / "_realms" / "bureaucracy_realm" / "corporations"
        / "teleport_massive_20250701" / "founders.json"
    )
...
def create_founder_lore(project_path: Path, fai_wei: Being):
    ...
    lore_path = (
        project_path / "_realms" / "bureaucracy_realm" / "corporations"
        / "teleport_massive_20250701" / "FAI_WEI_FOUNDER_LORE.md"
    )
...
"""
    ...
    try:
        ...
        print(f"✅ Created founder lore document")
    except Exception as e:
