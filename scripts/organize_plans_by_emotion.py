...
CATEGORIES = {
    "hopes": {
        "keywords": [
            "enhancement", "improvement", "upgrade", "polish", "refine",
            "feature", "add", "implement", "create", "build", "new",
            "integration", "connect", "expand", "extend", "evolve"
        ],
        "description": "Aspirational features, improvements, and enhancements"
    },
    "dreams": {
        "keywords": [
            "vision", "architecture", "system", "revolutionary", "transform",
            "paradigm", "foundation", "core", "prime directive", "celestial",
        "evolution", "reincarnation", "being", "reality", "cosmic", "eternal",
            "sovereign", "intelligence", "meta", "self-improving", "larval",
            "mature form", "heavy seed", "protocol"
        ],
        "description": "Visionary, ambitious, transformative ideas"
    },
    "dreads": {
        "keywords": [
            "fix", "bug", "error", "issue", "problem", "cleanup", "clean",
            "remove", "delete", "refactor", "audit", "review", "simplify",
            "maintenance", "debt", "technical debt", "update", "migration",
            "deprecate", "obsolete", "stale", "broken", "failure"
        ],
        "description": "Maintenance, fixes, technical debt, cleanup"
    },
    "fears": {
        "keywords": [
            "security", "vulnerability", "risk", "critical", "urgent",
            "failure", "crash", "error", "exception", "malformed",
            "scan", "remediation", "alert", "danger", "threat", "breach",
            "secret", "token", "key", "auth", "permission", "access"
        ],
    ...
    for category, config in CATEGORIES.items():
        ...
        for plan_path, metadata, cat, confidence in sorted_plans:
            ...
            if metadata.get("overview"):
                overview = metadata["overview"][:100] + "..." if len(metadata.get("overview", "")) > 100 else metadata["overview"]
