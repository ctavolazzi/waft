...
from src.waft.evolution.styling_genome import StylingGenomeRegistry, StylingGene, FontGene, MarginGene, ColorGene, LayoutGene
...
"""
    ...
    print(f"  ✅ Generated evolved design")
...
def main():
    ...
    print(f"🔄 Server updated with evolved UI")
...
def update_server_with_evolved_ui(evolved_html: str):
    ...
    new_content = (
        server_content[:html_start] +
        evolved_html +
        server_content[html_end:]
    )
    
    # Write back
    server_path.write_text(new_content, encoding="utf-8")
    print(f"  ✅ Updated server with evolved UI")
