...
"""
        ...
        generator = ScientificPDFGenerator.from_content(
            content=content,
            title="Batch Self-Examination Test",
    ...
    # Check wager outcome
    if wager:
        hypothesis_confirmed = test_results["tests"].get("self_examination", {}).get("hypothesis_confirmed", False)
