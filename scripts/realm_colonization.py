...
from src.waft.pantheon.mission_control import MissionControl
...
def colonize(
    ...
    realm_name: str = typer.Option(None, "--realm", "-r", help="Realm name (auto-generated if not provided)")
):
    """
...
"""
        console.print(Panel(panel_content.strip(), title="Colonization Result", border_style="green"))
