...
try:
    ...
    story.append(Paragraph("INSTITUTE FOR ADVANCED ONTOLOGICAL STUDIES", styles["CoverTitle"]))
    ...
    story.append(
        Paragraph(
            "─" * 60,
            ParagraphStyle(
                "Rule", parent=styles["Normal"], alignment=TA_CENTER, textColor=colors.grey
            ),
        )
    )
    ...
    story.append(
        Paragraph(
            "RESEARCH REPORT", ParagraphStyle("DocType", parent=styles["CoverTitle"], fontSize=18)
        )
    )
    ...
    warning_data = [
        [
            Paragraph(
                ...
                ParagraphStyle("Warning", parent=styles["ClinicalBody"], fontSize=10, leading=14),
            )
        ]
    ]
    ...
    story.append(Paragraph("Principal Investigator: Dr. [REDACTED]", styles["ClinicalBody"]))
    story.append(Paragraph("Date: January 10, 2026", styles["ClinicalBody"]))
