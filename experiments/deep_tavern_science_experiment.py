...
from examples.tavern_scenario import GameSession, tavern_scenario, create_character
...
def run_real_tavern_scenario(
    ...
    try:
        ...
        data_collector.record("successful_checks", sum(1 for c in session.skill_checks if c["success"]))
...
"""
    ...
    import markdown
    html_content = markdown.markdown(content_without_frontmatter, extensions=['extra', 'codehilite'])
