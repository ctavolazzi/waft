...
class Janitor:
    ...
    def cleanup_temp_files(self, directory: Path | None = None) -> dict[str, Any]:
        """
        Clean up temporary files.
    ...
    def cleanup_error_artifacts(self) -> dict[str, Any]:
        ...
        """
        error_patterns = ["**/*.error", "**/*.fail", "**/error_*.log", "**/crash_*.txt"]
    ...
    def fix_broken_symlinks(self) -> dict[str, Any]:
        ...
        return {"fixed": len(fixed), "symlinks": fixed}

    def cleanup_empty_directories(self, directory: Path | None = None) -> dict[str, Any]:
        """
        ...
        return {"cleaned": len(cleaned), "directories": cleaned[:20]}
