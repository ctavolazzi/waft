...
- **Version Update**: Incremental patch release (0.9.0 → 0.9.1)
- **Version Consistency**: Updated version in `pyproject.toml` and `src/waft/__init__.py` to maintain consistency
