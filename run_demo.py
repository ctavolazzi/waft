...
def run_porchroot_strategy():
    ...
    alternatives = ["PorchRoot (Maker Goods)", "FogSift (Consulting)", "NovaSystem (AI Agents)"]

    # Criteria: What matters most right now?
    # Let's say "Cash Flow" is King (0.5), but "Joy" is essential (0.3).
    criteria = {"Cash Flow Velocity": 0.5, "Joy & Fulfillment": 0.3, "Long-Term Scalability": 0.2}
