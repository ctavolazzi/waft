...
def test_analyze():
    ...
    request_data = {
        ...
        "criteria": {"Cash Flow": 0.6, "Joy": 0.4},
        "scores": {"PorchRoot": {"Cash Flow": 4, "Joy": 10}, "FogSift": {"Cash Flow": 9, "Joy": 6}},
    }

    response = requests.post(f"{BASE_URL}/api/decision/analyze", json=request_data)
