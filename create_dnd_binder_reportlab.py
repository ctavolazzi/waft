...
def create_quick_reference(styles):
    ...
    ability_ref_table = Table(
        ability_ref_data, colWidths=[1.5 * inch, 1 * inch, 1 * inch, 2.5 * inch]
    )
    ability_ref_table.setStyle(
        TableStyle(
            [
                ("BACKGROUND", (0, 0), (-1, 0), colors.HexColor("#34495e")),
                ("TEXTCOLOR", (0, 0), (-1, 0), colors.whitesmoke),
...
def main():
    ...
    print("📖 Opening ReportLab version on desktop...")
    print("   📚 Generated with ReportLab Platypus framework")
