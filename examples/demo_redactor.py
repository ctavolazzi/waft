...
from src.waft.redactor import PDFRedactor, SimplePDFRedactor, quick_redact
...
def demo_redactor():
    ...
    demo_pdf = Path("_work_efforts/showcase_documents/WAFT_Field_Guide_Complete_Booklet_PrinterFriendly.pdf")
