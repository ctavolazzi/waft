...
from src.waft.document_builder import DocumentBuilder, quick_collection, quick_field_guide
...
def example_collection():
    ...
    collection = DocumentBuilder.collection(
        title="Example Collection", subtitle="Multiple Documents"
    )

    # Add documents
    collection.add(
        DocumentBuilder.field_guide(
            title="Document 1", content="<h2>First Document</h2><p>Content here.</p>"
        ),
        section="Section 1",
    )
