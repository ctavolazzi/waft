...
from src.waft.core.corporations.teleport_massive import create_teleport_massive, get_founding_story
...
async def main():
    ...
    print(f"   Mission: {corporation.mission[:80]}..." if len(corporation.mission) > 80 else f"   Mission: {corporation.mission}")
    print()
    ...
    if runway:
        ...
        print(f"   Runway Value:        ${(financial.cash / financial.get_burn_rate() * financial.get_burn_rate()):>15,.2f}")
    else:
            ...
            if transaction.transaction_type == TransactionType.SALARY:
                ...
                if emp:
                    try:
                        ...
                        recipient_name = being.custom_name if being and being.custom_name else emp.title
                    except:
