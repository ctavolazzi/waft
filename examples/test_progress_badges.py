...
from src.waft.evolution.styling_genome import StylingGenomeRegistry, StylingGene, FontGene, MarginGene, ColorGene, LayoutGene, StylingGenome
...
def main():
    ...
    components.append(builder.build_progress_bar_component("Epistemic Knowledge", 65, 100, show_fraction=False))
