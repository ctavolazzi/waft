...
"""
    ...
    output_path = (
        project_root
        / "_work_efforts"
        / "WE-260115-weul_gemini_ai_dnd_integration_for_campaign_pdfs"
        / "test_campaign_with_gemini.pdf"
    )
    ...
    try:
        generator = PDFGenerator.from_content(
            content=content, title=campaign_data["name"], style="premium", use_golden_triangle=True
        )
