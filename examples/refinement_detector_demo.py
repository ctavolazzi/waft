...
from waft.core.self_engineering import RefinementDetector
...
'''
    ...
    console.print(
        f"[green]✓[/green] Found {len(opportunities)} refinement opportunity/opportunities"
    )

    # Display results
    if opportunities:
        table = Table(
            title="Refinement Opportunities", show_header=True, header_style="bold magenta"
        )
