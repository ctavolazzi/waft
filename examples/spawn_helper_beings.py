...
def spawn_helper_team():
    ...
    console.print(
        "[bold bright_blue]║[/bold bright_blue]  [bold white]SPAWNING HELPER BEINGS[/bold white]  [bold bright_blue]║[/bold bright_blue]"
    )
    console.print(
        "[bold bright_blue]╚════════════════════════════════════════╝[/bold bright_blue]\n"
    )
    ...
    for helper in helpers:
        ...
        being = being_system.spawn_being(
            reality_id="helper_reality", initial_skills=helper["skills"]
        )
    ...
    for item in spawned_beings:
        ...
        for skill_name, skill_level in sorted(
            being.skills.items(), key=lambda x: x[1], reverse=True
        ):
    ...
    console.print(
        f"[bold green]✓ Successfully spawned {len(spawned_beings)} helper beings![/bold green]\n"
    )
