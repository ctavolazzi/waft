...
def document_card_game(
    game_name: str, rules: str, example_hands: list[dict[str, Any]], output_path: Path
) -> Path:
    """
...
- **Memory Challenge**: Any player can challenge the sequence at any time
    ...
    pdf_path = document_card_game(
        game_name=game_name, rules=rules, example_hands=example_hands, output_path=output_path
    )
