...
def main():
    ...
    while True:
        ...
        console.print(
            "  3. [cyan]Evolve[/cyan] - Run a full evolutionary cycle (Observe → Reflect → Learn)"
        )
        ...
        if choice == "1":
            ...
            console.print(
                f"[cyan]Success:[/cyan] {'✅ Yes' if observation.probe_result.success else '❌ No'}"
            )
            ...
            console.print("[green]✓[/green] Prime Being state saved")
