...
def main():
    ...
    print(f"✓ Overall health: {typed_state.overall_health_status} ({typed_state.overall_health_score:.1f})")
    print()
    ...
    distilled = distiller.distill_text(
        "WAFT Kernel Status Report (Typed State)",
        title="Status Report"
    )
    ...
    print(f"  ✓ Computed properties used throughout")
    print()
