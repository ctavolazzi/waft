...
```
/generate-waft-docs field-guide
```
...
```
/generate-waft-docs field-guide --printer-friendly
```
...
```
/generate-waft-docs session-summary
```
...
### Redact PDF
```
/generate-waft-docs redact --input path/to/file.pdf --areas "100,200,300,400"
```
...
**Individual Level**:
```
/generate-waft-docs field-guide --level layman
/generate-waft-docs field-guide --level professional
/generate-waft-docs field-guide --level scientist
```
...
**Complete Booklet**:
```
/generate-waft-docs booklet
```

**Printer-Friendly Booklet**:
```
/generate-waft-docs booklet --printer-friendly
```
...
**Custom Summary**:
```
/generate-waft-docs session-summary --title "Custom Title" --focus "specific topic"
```
...
**Redact Areas**:
```
/generate-waft-docs redact --input file.pdf --areas "x1,y1,w1,h1" "x2,y2,w2,h2"
```

**Redact with Labels**:
```
/generate-waft-docs redact --input file.pdf --areas "100,200,300,400:classified" "500,600,200,100:secret"
```
...
### Standard Workflow
```
1. /generate-waft-docs field-guide          → Generate all three field guides
2. /generate-waft-docs booklet              → Assemble complete booklet
3. /generate-waft-docs field-guide --printer-friendly  → Generate printer-friendly versions
4. /generate-waft-docs booklet --printer-friendly      → Assemble printer-friendly booklet
```

### Quick Workflow
```
/generate-waft-docs all
```
...
```
/generate-waft-docs redact --input _work_efforts/showcase_documents/SESSION_SUMMARY_2026-01-11.pdf --areas "100,200,300,400" "500,600,200,100"
```
...
**Don't use `/generate-waft-docs` when**:
